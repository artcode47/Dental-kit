...
const HomePage = () => {
	...
	const features = [
		{ icon: ShieldCheckIcon, title: t('home.features.premiumQuality.title'), description: t('home.features.premiumQuality.description') },
		{ icon: TruckIcon, title: t('home.features.fastShipping.title'), description: t('home.features.fastShipping.description') },
		{ icon: ClockIcon, title: t('home.features.support.title'), description: t('home.features.support.description') },
		{ icon: UserGroupIcon, title: t('home.features.expertTeam.title'), description: t('home.features.expertTeam.description') }
	];

	const testimonials = [
		{ name: t('home.testimonials.drSarah.name'), role: t('home.testimonials.drSarah.role'), content: t('home.testimonials.drSarah.content'), rating: 5, avatar: 'https://images.unsplash.com/photo-1559839734-2b71ea197ec2?w=150&h=150&fit=crop&crop=face' },
		{ name: t('home.testimonials.drMichael.name'), role: t('home.testimonials.drMichael.role'), content: t('home.testimonials.drMichael.content'), rating: 5, avatar: 'https://images.unsplash.com/photo-1612349317150-e413f6a5b16d?w=150&h=150&fit=crop&crop=face' },
		{ name: t('home.testimonials.drEmily.name'), role: t('home.testimonials.drEmily.role'), content: t('home.testimonials.drEmily.content'), rating: 5, avatar: 'https://images.unsplash.com/photo-1594824476967-48c8b964273f?w=150&h=150&fit=crop&crop=face' }
	];
	...
	return (
		<div className="relative z-10 min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-sky-100 dark:from-gray-900 dark:via-gray-800 dark:to-gray-900 overflow-x-hidden">
			...
			<section className="py-8 sm:py-12 lg:py-16 bg-white dark:bg-gray-800">
				<div className="container mx-auto px-4">
					<div className="text-center mb-8 sm:mb-12">
						<h2 className="text-2xl sm:text-3xl lg:text-4xl font-bold text-gray-900 dark:text-white mb-3 sm:mb-4">{t('home.features.title')}</h2>
						<p className="text-base sm:text-lg lg:text-xl text-gray-600 dark:text-gray-300 max-w-3xl mx-auto px-4">{t('home.features.subtitle')}</p>
					</div>
						...
						{features.map((feature) => {
							...
							return (
								<div key={feature.title} className="text-center">
									<div className="w-12 h-12 sm:w-16 sm:h-16 bg-gradient-to-br from-sky-500 to-blue-600 rounded-2xl flex items-center justify-center mx-auto mb-4 sm:mb-6">
			...
			<section className="py-8 sm:py-12 lg:py-16 bg-gradient-to-br from-gray-50 to-blue-50 dark:from-gray-900 dark:to-gray-800">
				<div className="container mx-auto px-4">
					<div className="text-center mb-8 sm:mb-12">
						<h2 className="text-2xl sm:text-3xl lg:text-4xl font-bold text-gray-900 dark:text-white mb-3 sm:mb-4">{t('home.testimonials.title')}</h2>
						<p className="text-base sm:text-lg lg:text-xl text-gray-600 dark:text-gray-300 px-4">{t('home.testimonials.subtitle')}</p>
					</div>
			...
			<section className="pt-8 pb-4 sm:pt-12 sm:pb-6 lg:pt-16 lg:pb-8 bg-gradient-to-r from-sky-500 via-blue-500 to-sky-600">
				<div className="container mx-auto px-4 text-center">
					<h2 className="text-2xl sm:text-3xl lg:text-4xl font-bold text-white mb-4 sm:mb-6">{t('home.cta.title')}</h2>
					<p className="text-base sm:text-lg lg:text-xl text-blue-100 mb-6 sm:mb-8 max-w-2xl mx-auto px-4">{t('home.cta.subtitle')}</p>
					<div className="flex flex-col sm:flex-row gap-3 sm:gap-4 justify-center">
						<Button size="lg" className="bg-white text-blue-600 hover:bg-gray-100 font-semibold px-6 sm:px-8 py-3 sm:py-4 text-base sm:text-lg" onClick={() => (window.location.href = '/products')}>
							{t('home.cta.getStarted')}
							<ArrowRightIcon className="w-5 h-5 ml-2" />
						</Button>
						<Button variant="outline" size="lg" className="border-white text-white hover:bg-white hover:text-blue-600 font-semibold px-6 sm:px-8 py-3 sm:py-4 text-base sm:text-lg">
