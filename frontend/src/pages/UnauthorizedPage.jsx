        ...
        <div className={`max-w-4xl w-full text-center transition-all duration-700 transform ${
          ...
          <div className={`mb-12 p-6 rounded-2xl backdrop-blur-sm ${
            ...
            <h3 className={`text-lg font-semibold mb-2 ${
              ...
              {isAuthenticated 
                ? t('errors.unauthorized.authenticatedTitle')
                : t('errors.unauthorized.notAuthenticatedTitle')
              }
            </h3>
            ...
            <p className={`text-sm ${
              ...
              {isAuthenticated 
                ? t('errors.unauthorized.authenticatedMessage')
                : t('errors.unauthorized.notAuthenticatedMessage')
              }
            </p>
          </div>
          ...
          {!isAuthenticated && (
            <div className={`mb-12 p-6 rounded-2xl backdrop-blur-sm ${
              ...
              <h3 className={`text-lg font-semibold mb-4 ${
                ...
                {t('errors.unauthorized.authActionsTitle')}
              </h3>
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
                ...
                <Button
                  ...
                  className="min-w-[160px]"
                >
                  {t('errors.unauthorized.register')}
                </Button>
              </div>
            </div>
          )}
          ...
          <div className={`p-6 rounded-2xl backdrop-blur-sm ${
            ...
            <h3 className={`text-lg font-semibold mb-4 ${
              ...
              {t('errors.unauthorized.quickLinksTitle')}
            </h3>
          ...
          <div className={`mt-8 p-4 rounded-xl ${
            ...
            <p className={`text-sm ${
              ...
              >
                {t('errors.unauthorized.contactUs')}
              </Link>
            </p>
          </div>
        </div>
