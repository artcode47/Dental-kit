...
const Button = React.forwardRef(({
  ...
  const variants = {
    primary: 'bg-gradient-to-r from-sky-600 to-blue-600 text-white hover:from-sky-700 hover:to-blue-700 focus:ring-sky-500 active:from-sky-800 active:to-blue-800 shadow-lg hover:shadow-xl transition-all duration-200',
    ...
    info: 'bg-gradient-to-r from-sky-600 to-blue-600 text-white hover:from-sky-700 hover:to-blue-700 focus:ring-sky-500 active:from-sky-800 active:to-blue-800 shadow-lg hover:shadow-xl transition-all duration-200',
    ...
    outline: 'border-2 border-sky-600 text-sky-600 hover:bg-gradient-to-r hover:from-sky-50 hover:to-blue-100 dark:border-sky-400 dark:text-sky-400 dark:hover:from-sky-900/20 dark:hover:to-blue-800/20 focus:ring-sky-500 active:from-sky-100 dark:active:from-sky-900/40 shadow-md hover:shadow-lg transition-all duration-200',
    ghost: 'text-sky-600 hover:bg-gradient-to-r hover:from-sky-50 hover:to-blue-100 dark:text-sky-400 dark:hover:from-sky-900/20 dark:hover:to-blue-800/20 focus:ring-sky-500 active:from-sky-100 dark:active:from-sky-900/40 transition-all duration-200',
    link: 'text-sky-600 hover:text-sky-800 dark:text-sky-400 dark:hover:text-sky-300 focus:ring-sky-500 underline transition-colors duration-200'
  };
